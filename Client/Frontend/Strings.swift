...
extension Strings {
    ...
    // Label used as an item in Settings. When touched it will open a dialog to setup advance TheHive account settings.
    public static let SettingsAdvanceAccountSectionName = "Account Settings"

    // Settings.AdvanceAccount.SectionFooter
    // Details for using custom TheHive Account service.
    public static let SettingsAdvanceAccountSectionFooter = "To use a custom TheHive Account and sync servers, specify the root Url of the TheHive Account site. This will download the configuration and setup this device to use the new service. After the new service has been set, you will need to create a new TheHive Account or login with an existing one."
    ...
    public static let SettingsAdvanceAccountUrlUpdatedAlertMessage = "TheHive account service updated. To begin using custom server, please log out and re-login."
    ...
    public static let SettingsAdvanceAccountUrlErrorAlertMessage = "There was an error while attempting to parse the url. Please make sure that it is a valid The Hive Account root url."
...
extension Strings {
    ...
    public static let UnableToOpenURLError = NSLocalizedString("UnableToOpenURLError", bundle: Bundle.shared, value: "The Hive cannot open the page because it has an invalid address.", comment: "The message displayed to a user when they try to open a URL that cannot be handled by TheHive, or any external app.")
...
extension Strings {
    ...
    public static let ScanQRCodePermissionErrorMessage = NSLocalizedString("ScanQRCodePermissionErrorMessage", bundle: Bundle.shared, value: "Please allow TheHive to access your device’s camera in ‘Settings’ -> ‘Privacy’ -> ‘Camera’.", comment: "Text of the prompt user to setup the camera authorization.")
