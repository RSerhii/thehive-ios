...
open class TheHiveGlobalShieldStats {
    public static let shared = TheHiveGlobalShieldStats()
    public static let DidUpdateNotification = "TheHiveGlobalShieldStatsDidUpdate"
    ...
    private func postUpdateNotification() {
        NotificationCenter.default.post(name: Notification.Name(rawValue: TheHiveGlobalShieldStats.DidUpdateNotification), object: nil)
    }
