...
public struct TheHiveUX {    
    public static let TheHivePrivacyURL = URL(string: "https://thehive.com/about/privacy-policy")!
    public static let TheHiveTermsOfUseURL = URL(string: "https://thehive.com/about/terms-of-use")!
    public static let TheHiveSupportURL = URL(string: "https://thehive.com/help/support")!
    ...
    public static let TheHiveGreen = UIColor(rgb: 0x00d177)
    ...
    public static let TheHiveButtonMessageInUrlBarColor = TheHiveGreen
    public static let TheHiveButtonMessageInUrlBarShowTime = 0.5
    public static let TheHiveButtonMessageInUrlBarFadeTime = 0.7
